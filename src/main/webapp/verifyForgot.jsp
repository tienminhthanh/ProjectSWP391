...
<html lang="en">
    <head>
        ...
        <title>WIBOOKS - Forgot Password</title>
    ...
    <body class="bg-gray-100">
        ...
        <div class="max-w-3xl mx-auto p-6">
            <div class="w-full bg-white p-8 shadow-md rounded-lg">
                <h1 class="text-3xl font-bold text-blue-600 mb-6 text-center">Forgot Password</h1>
                ...
                <div class="text-center">
                    <a href="login.jsp" class="bg-white border border-gray-300 text-gray-600 py-2 px-4 rounded-full flex items-center justify-center mx-auto hover:bg-gray-200 transition duration-200">
                        <i class="fas fa-arrow-left mr-2"></i> Restart the Login
                    </a>
                </div>
            </div>
        </div>
